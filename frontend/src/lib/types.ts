...
export interface NodeSpec {
  ...
  height: number;
  label?: string;
  // Add any other node-specific properties needed for layout or rendering
  metadata?: Record<string, any>; // For additional custom data
}
...
export interface EdgeSpec {
  ...
  label?: string;
  // Add any other edge-specific properties needed for layout or rendering
  metadata?: Record<string, any>; // For additional custom data
}
// --- End Graph Layout Types ---
